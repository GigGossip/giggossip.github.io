...
When visiting our website, we utilize Google Analytics, a web analytics service provided by Google, Inc. ("Google"), to collect standard internet log information and details of visitor behavior patterns. This tool helps us analyze how visitors use the site, enabling us to improve our website and tailor it more to our users' needs. The data gathered, including the number of visitors to various parts of the site, is processed in a manner that does not identify any individual. We do not make, and do not allow Google to make, any attempt to find out the identities of those visiting our website. For more information on how Google processes and collects your information in relation to Google Analytics and how you can opt-out, please refer to Google’s privacy policy.
...
If you have any questions about this Privacy Policy, You can contact us: [hello@thehyperlabs.com](mailto:hello@thehyperlabs.com)